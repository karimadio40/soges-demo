        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            ...
            <div className="footer__socials">
              {/* WhatsApp */}
              <a href="https://wa.me/message/ADZLV5HCBVJCH1" target="_blank" rel="noreferrer" className="footer__social" aria-label="WhatsApp">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/share/18egmwnxVd/" target="_blank" rel="noreferrer" className="footer__social" aria-label="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                </svg>
              </a>
              {/* Google Maps */}
              <a href="https://maps.app.goo.gl/2G1HXe7XmMKwvkYG8" target="_blank" rel="noreferrer" className="footer__social" aria-label="Google Maps">
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              {services.map((s) => (
                <li key={s}>
                  <button className="footer__link" onClick={() => scrollTo('services')}>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width="12" height="12">
                      <path d="M5 12h14M12 5l7 7-7 7"/>
                    </svg>
                    {s}
          ...
          <div className="footer__col">
            ...
            <ul className="footer__contact-list">
              <li>
                ...
                <span>Cocody Riviera Palmeraie, Abidjan</span>
              </li>
              <li>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="15" height="15">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>
                </svg>
                <a href="mailto:soges.devis.infos@gmail.com">soges.devis.infos@gmail.com</a>
              </li>
              <li>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" width="15" height="15">
                ...
                <a href="tel:+2250749787811">+225 07 49 78 78 11</a>
              </li>
            </ul>
          </div>
        </div>
